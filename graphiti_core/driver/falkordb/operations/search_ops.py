...
class FalkorSearchOperations(SearchOperations):
    ...
    async def edge_similarity_search(
        ...
        cypher = (
            ...
            + """
            WITH DISTINCT e, n, m, """
            + get_vector_cosine_func_query('e.fact_embedding', '$search_vector')
            + """ AS score
            WHERE score > $min_score
            RETURN
            """
    ...
    def build_node_search_filters(self, search_filters: SearchFilters) -> Any:
        filter_queries, filter_params = node_search_filter_query_constructor(search_filters)
    ...
    def build_edge_search_filters(self, search_filters: SearchFilters) -> Any:
        filter_queries, filter_params = edge_search_filter_query_constructor(search_filters)
        return {'filter_queries': filter_queries, 'filter_params': filter_params}
